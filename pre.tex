...
%
% --- Example Usage ---
\usepackage[iitb,en]{collegeBeamer}
\useLUTheme{} 
\useSplitBackground


% meta-eata
\title{IIT Bombay Beamer Template}
...
\begin{frame}
	This template is inspired and modified from \bhref{https://github.com/liu-qilong/college-beamer}{College Beamer} and \bhref{https://www.overleaf.com/latex/templates/leiden-university-beamer-theme/rsqdqhdcnsgy}{Leiden University Beamer Theme} templates. \vspace{\baselineskip}
...
\begin{frame}{Beamer for SINTEF slides}
	...
	\end{itemize}
	\vspace{2em}
	Note: This template has navigation buttons at the bottom by default, for each slide of a topic. You can click on the topic headings as well.
\end{frame}
\begin{frame}{Blocks (from LU Theme)}
	\begin{definition}
